...
// Stack
//------------------------------------------------------------------------------
#define	SAFEZONE	128															// $CMT-ygkim-150730: to make safe stack ptr
#define EXCEPTION_STACK_SIZE (128 + SAFEZONE)									// $CMT-ygkim-150730: 128 bytes needs to save 32 GPRS
...
#define	VAR_ENTRY(symbol)				 \
	ENTRY(symbol)						;\
	.word	0x0																	// $CMT-ygkim-150730: to define word label for global variables
...
#define LCALL(func)                      \
    ...
    l.ori   r3,r3,lo(func)              ;\
    l.jalr  r3                          ;\
    l.nop                               										// $CMT-ygkim-150730: long jump with 32 bit address

#define SCALL(func)                      \
	l.jal	func						;\
    l.nop                               										// $CMT-ygkim-150730: short jump with 26 bit offset (relative address)

#define SCALL_DEFAULT_XSR				 \
	l.mfspr	r3, r0, EXR1K_NPC			;\
	l.mfspr	r4, r0, EXR1K_EPCR			;\
	SCALL(default_xsr)															// $CMT-ygkim-150730: r3, r4 used for function arguments

#define PROLOG                           \
    l.addi  r1,r1,-EXCEPTION_STACK_SIZE ;\
    l.sw    0x1c(r1),r9                 ;\
	SCALL(_save_gpr)															// $CMT-ygkim-150730: save r9 first before SCALL() due to r9 changed @SCALL
...
#define EPILOG                           \
    ...
    l.rfe                               ;\
    l.nop								;\
    FILL_NOPS																	// $CMT-ygkim-150730: restore r9 last after SCALL() due to r9 changed @SCALL
...
#define	FILL_NOPS						 \
    ...
    l.nop                               ;\
    l.nop                               ;\
    l.nop                               										// $CMT-ygkim-150730: to fill nops @ the end of code for prefetch and prediction stages
...
#define	FILL_NOPS_1CACHE_LINE			 \
    ...
    l.nop                               ;\
    l.nop                               ;\
    l.nop                               										// $CMT-ygkim-150820: to fill nops @ the end of code for HWP
